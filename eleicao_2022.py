...
while True:
    ...
    plt.ylim(0, 70)
    plt.xlim(datetime.datetime(2022,10,30,15,40), datetime.datetime(2022,10,30,21,30))
    plt.xticks([datetime.datetime(2022,10,30,16,0,0), datetime.datetime(2022,10,30,16,30,0),
                datetime.datetime(2022,10,30,17,0,0), datetime.datetime(2022,10,30,17,30,0),
                ...
                labels = ['16:00', '16:30', '17:00', '17:30', '18:00', '18:30', '19:00',
    ...
    print(f"Waiting {(waiting_sec/60):.1f} min to update again - Hour = {hour_now}:{min_now}")
